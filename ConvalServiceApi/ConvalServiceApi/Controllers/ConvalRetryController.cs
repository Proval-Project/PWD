    ...
    public class ConvalRetryController : ApiController
    {
                        ...
                        if (existingCount > 0)
                        {
                            ...
                            sql = @"
                                UPDATE DataSheetLv3 SET
                                    ...
                                    SS100Max = @SS100Max, SS100Nor = @SS100Nor, SS100Min = @SS100Min, SS100Unit = @SS100Unit,
                                    ...
                                    FlowDirection = @FlowDirection, ValvePerformClass = @ValvePerformClass,
                                    Protection = @Protection, BasicCharacter = @BasicCharacter, 
                                    TheoreticalRangeability = @TheoreticalRangeability, TheoreticalRangeabilityUnit = @TheoreticalRangeabilityUnit,
                        ...
                        else
                        {
                            ...
                            sql = @"
                                INSERT INTO DataSheetLv3 (
                                    ...
                                    SS100Max, SS100Nor, SS100Min, SS100Unit,
                                    ...
                                    FlowDirection, ValvePerformClass,
                                    Protection, BasicCharacter, TheoreticalRangeability, TheoreticalRangeabilityUnit,
                                    ...
                                    @Density, @DensityUnit, @MolecularWeight, @MolecularWeightUnit,
                                    @CalculatedCvMaxQ, @CalculatedCvNorQ, @CalculatedCvMinQ, @CalculatedCvUnit,
                                    @SS100Max, @SS100Nor, @SS100Min, @SS100Unut,
                                    @U1Max, @U1Nor, @U1Min, @U1Unit,
                                    @U2Max, @U2Nor, @U2Min,
                                    @LpAeMax, @LpAeNor, @LpAeMin,
                                    @WarningStateMax, @WarningStateNor, @WarningStateMin,
        ...
        private void MapFrontendDataToSqlParameters(MySqlCommand command, Dictionary<string, object> convalData)
        {
            ...
            var fieldMapping = new Dictionary<string, string>
            {
                ...
                {"TheoreticalRangeabilityUnit", "@TheoreticalRangeabilityUnit"},
                {"FlowCoeff", "@FlowCoeff"},
